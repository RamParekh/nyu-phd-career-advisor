...
try:
    ...
    ADZUNA_APP_ID = st.secrets["api_keys"]["adzuna_app_id"]
    ADZUNA_APP_KEY = st.secrets["api_keys"]["adzuna_app_key"]
except:
    # Fallback to environment variables or placeholder for local development
    import os
...
# NOW CALCULATE THEMATIC SENTIMENTS (after functions are defined)
if processed_sentiment_df is not None:
    ...
    theme_sentiments = extract_theme_sentiments(processed_sentiment_df, themes)
else:
